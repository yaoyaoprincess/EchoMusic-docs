...
| 插件 | 说明 | 作者 |
|------|------|------|
| [自定义图标](https://github.com/oneday5799/EchoMusicPlugins/tree/main/custom-icon) | 自定义托盘图标、窗口标题栏图标、任务栏图标、桌面快捷方式图标及启动画面 | Oneday5799 |
| [Echo 液态折射](https://github.com/SkyShadowHero/echo-liquid-glass) | 为底部音乐控件添加液态折射效果，可调整参数至 iOS 或鸿蒙风格。需配合 echo-miuix-plugin 使用 | 天影大侠 |
| [Echo Miuix](https://github.com/SkyShadowHero/echo-miuix-plugin) | 将 EchoMusic 界面改为 MIUIX（小米澎湃）风格 | 天影大侠 |
| [Blue Archive 主题包](https://github.com/venti1112/echo_music-blue_archive-theme) | 蔚蓝档案主题包，可自定义调整 | venti1112 |
## 🎵 歌词与播放
...
| 插件 | 说明 | 作者 |
|------|------|------|
| [黑胶唱片旋转](https://github.com/hoowhoami/EchoMusicPlugins/tree/main/echomusic-vinyl-rotation) | 黑胶唱片旋转动效，基于封面图片实时渲染 | hoowhoami |
| [频谱可视化](https://github.com/hoowhoami/EchoMusicPlugins/tree/main/spectrum-visualizer) | 音频频谱可视化，支持播放栏、迷你播放器和歌词页面多场景展示 | hoowhoami |
## ☁️ 音源与存储
...
| [小功能](https://github.com/Max8808/xiaotoolkit) | 热门排序 + 隐藏歌单 + 歌词隐藏控制栏和工具栏 + 隐藏听歌识曲 + 顶部插件按钮 + 桌面特效 | Max8808 |
## 📚 开发示例

| 插件 | 说明 | 作者 |
|------|------|------|
| [示例插件](https://github.com/hoowhoami/EchoMusicPlugins/tree/main/example-plugin) | 官方示例插件，展示歌词动效、浮窗、Now Playing 等完整功能 | hoowhoami |
